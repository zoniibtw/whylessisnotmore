            ...
            <div className="">
              <Reveal keyframes={customAnimation} triggerOnce delay={100}>
                <p className="text-[20px] leading-[20px] text-white font-light w-[68%] max-lg:w-[80%] max-md:w-full">
                  ...
                  established, well-known brands. We hope to inspire you with
                  our top picks of beautiful things from interior design and
                  homeware to unique hotels and spaces.
                </p>
              </Reveal>
            </div>
