            ...
            <div className="flex justify-end items-end w-full">
              ...
              >
                <div className="flex flex-col items-start">
                    <p className="text-[28px] leading-[28px] font-normal">Enter</p>
                    <p className="text-[28px] leading-[28px] font-light">Whylessisnotmore</p>
                </div>
                <span className="flex items-center w-24 h-10 border-2 rounded-full overflow-hidden group-hover:bg-white group-hover:text-[var(--background-color)] group-hover:border-[var(--text-color)] transition-colors duration-500 ease-out">
                  <span className="relative w-full flex items-center justify-center rotate-[0.01deg] transition-transform duration-500 ease-out group-hover:translate-x-[80px]">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-6 absolute top-0 -left-11">
