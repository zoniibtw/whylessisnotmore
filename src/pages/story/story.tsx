...
function Story() {
    return ( 
        <>
            <div className="bg-light-purple max-md:hidden">
                <Section>
                ...
                <Section>
                    <div className="flex flex-col w-full py-[10%] gap-10">
                        <div className="w-full">
                            <div className="bg-cover bg-no-repeat bg-right w-full h-[45vh]" style={{
                                backgroundImage: `linear-gradient(to bottom, rgba(15, 25, 32, 0), rgba(15, 25, 32, 0)), url(${Image})`,
                            }}></div>
                        </div>
                        ...
                        <div className="w-full flex flex-col items-center justify-center mb-10">
                            <div className="flex flex-col gap-5">
                                <h1 className="text-[25px] leading-[25px] text-black">A personal view of beauty</h1>
                                <p className="test-[14px] leading-[18px] text-black">
                                    With a background working in fashion, interior design 
                                    and high-end real estate, our founder Louisa Falkenberg 
                                    has experience building homes, curating spaces and 
                                    beautifying your way of living. Louisa is currently based 
